...
.PHONY: all lab1 lab2 lab3 lab4 lab5 lab5-2 lab6 lab7

all: lab1 lab2 lab3 lab4 lab5 lab5-2 lab6 lab7
...
lab5: lab5/gun.cpp lab5/lab5.h lab5/lab5-1.cpp lab5/lab5-2.cpp lab5/magicional_gun.cpp
	$(CC) $(cflags) lab5/gun.cpp lab5/lab5-1.cpp lab5/magicional_gun.cpp -o lab5-1.out
	$(CC) $(cflags) lab5/gun.cpp lab5/lab5-2.cpp lab5/magicional_gun.cpp -o lab5-2.out

lab5-2: lab5-2/gun.cpp lab5-2/lab5.h lab5-2/lab5-2.cpp lab5-2/magicional_gun.cpp lab5-2/one_time_gun.cpp
	$(CC) $(cflags) lab5-2/gun.cpp lab5-2/lab5-2.cpp lab5-2/magicional_gun.cpp lab5-2/one_time_gun.cpp -o lab5-3.out

lab6: lab6/lab6.cpp lab6/lab6.h
	$(CC) $(cflags) lab6/lab6.cpp -o lab6.out

lab7: lab7/lab7-1.cpp lab7/lab7-2.cpp lab7/lab7-3.cpp lab7/lab7-4.cpp lab7/settings.cpp lab7/lab7-4.h
	$(CC) $(cflags) lab7/lab7-1.cpp -o lab7-1.out
	$(CC) $(cflags) lab7/lab7-2.cpp -o lab7-2.out
	$(CC) $(cflags) lab7/lab7-3.cpp -o lab7-3.out
	$(CC) $(cflags) lab7/lab7-4.cpp lab7/settings.cpp -o lab7-4.out
